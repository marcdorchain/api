...
export class FilterSelectComponent {
  ...
  constructor() {
    this.dataSource.data = [
      ...
      {name: "Request Validation", children: [
        {name: RouteFilterTypeNameMapping.get(RouteFilterType.ZDZW_LICENSE_VERIFICATION)!, value: RouteFilterType.ZDZW_LICENSE_VERIFICATION},
        {name: RouteFilterTypeNameMapping.get(RouteFilterType.ZDZW_SMARTCONTRACT_VERIFICATION)!, value: RouteFilterType.ZDZW_SMARTCONTRACT_VERIFICATION}
      ]}
    ];
