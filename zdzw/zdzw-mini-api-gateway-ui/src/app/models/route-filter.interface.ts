...
export enum RouteFilterType {
    ZDZW_LICENSE_VERIFICATION = "ZDZW_LICENSE_VERIFICATION",
    ZDZW_SMARTCONTRACT_VERIFICATION = "ZDZW_SMARTCONTRACT_VERIFICATION",
...
export interface ZDZWLicenseVerification_RouteFilter extends RouteFilter {
    type: RouteFilterType.ZDZW_LICENSE_VERIFICATION;
    appId: string;
}

export interface ZDZWSmartContractVerification_RouteFilter extends RouteFilter {
