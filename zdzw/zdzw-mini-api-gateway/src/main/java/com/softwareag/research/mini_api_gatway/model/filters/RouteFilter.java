...
import com.softwareag.research.mini_api_gatway.model.filters.zdzw.ZDZWLicenseVerificationFilter;
import com.softwareag.research.mini_api_gatway.model.filters.zdzw.ZDZWSmartContractVerificationFilter;
...
@JsonSubTypes({
	@Type(value = ZDZWLicenseVerificationFilter.class, name = "ZDZW_LICENSE_VERIFICATION"),
	@Type(value = ZDZWSmartContractVerificationFilter.class, name = "ZDZW_SMARTCONTRACT_VERIFICATION"),
