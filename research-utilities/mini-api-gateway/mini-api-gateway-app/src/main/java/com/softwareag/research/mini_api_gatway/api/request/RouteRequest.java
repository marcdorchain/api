...
public class RouteRequest {
	...
	/**
	 * Activation status of the paths of this route
	 */
	@Schema(description = "Activation status of the paths of this route")
	...
	private RouteSettings settings = new RouteSettings();
}